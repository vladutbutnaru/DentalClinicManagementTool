	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="stocuri.jsp">Stocuri</a></li>
				<li class="active">Adauga stocuri</li>
			</ul>
			<!-- END BREADCRUMB -->

			<div class="page-title">
				<h2>
					<span class="fa fa-arrow-circle-o-left"></span> Adauga stocuri
				</h2>
			</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								%>
								<!-- START ONE PRODUCT PANEL -->
								<div class="col-md-12 scCol ui-sortable">

									<div class="panel panel-success" id="grid_block_5">
										<div
											class="panel-heading ui-draggable-handle ui-sortable-handle">
											<h3 class="panel-title"><%=produs.getNumeProdus() %></h3>
										</div>
										<div class="panel-body">
                                        ...
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<%=produs.getCantitateProdus() %>" aria-valuemin="0" aria-valuemax="<%=produs.getMaxValue() %>" style="width: <%=(produs.getCantitateProdus()/produs.getMaxValue()) * 100 %>%">
                                           <%}
											else{ %>
                                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<%=produs.getCantitateProdus() %>" aria-valuemin="0" aria-valuemax="<%=produs.getMaxValue() %>" style="width: 1%">
                                      
                                           
                                           
                                           <%} %>
                                           <%=produs.getCantitateProdus() %>
                                        </div>
                                    </div>
                                    <br>
